...
<section style="padding: 25vh 0px 120px 0px; height: 85vh;">
  <div class="row">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <form action="{{route('post.g9')}}" method="post">
                  <div class="panel-heading"><?= $gejalas[8]['nama_gejala'];  ?></div>
                      <div class="panel-body">
                      
                        {{csrf_field()}}
                        <div class="form-check form-check-inline">
                          <input class="form-check-input" type="radio" name="pilihan" id="inlineRadio1" value="<?= $gejalas[8]['kode_gejala'];  ?>">
